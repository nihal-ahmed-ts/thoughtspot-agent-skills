...
| [`ts-convert-from-qlik`](agents/cli/ts-convert-from-qlik/SKILL.md) | Convert a Qlik Sense app via the Qlik Cloud API into ThoughtSpot Table and Model TMLs, with optional sheet-to-liveboard migration | [coverage](agents/cli/ts-convert-from-qlik/references/coverage-matrix.md) | [✓](agents/cli/ts-convert-from-qlik/SKILL.md) | — | — |
| [`ts-convert-from-qlik-manual`](agents/cli/ts-convert-from-qlik-manual/SKILL.md) | Convert a Qlik Sense dashboard without Qlik API access (.qvf + dashboard PDF + data model) into ThoughtSpot Table and Model TMLs, with optional liveboard migration | [coverage](agents/cli/ts-convert-from-qlik-manual/references/coverage-matrix.md) | [✓](agents/cli/ts-convert-from-qlik-manual/SKILL.md) | — | — |
