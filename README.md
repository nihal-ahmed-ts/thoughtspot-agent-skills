...
| [`ts-convert-from-domo`](agents/cli/ts-convert-from-domo/SKILL.md) | Convert a captured offline Domo bundle (dataset schemas, Beast Modes, cards, page) into ThoughtSpot Table + Model TMLs and Answers/tabbed Liveboard, translating Beast Mode formulas and taking model joins from a Magic ETL export | Domo | [coverage](agents/cli/ts-convert-from-domo/references/coverage-matrix.md) | [✓](agents/cli/ts-convert-from-domo/SKILL.md) | — | — |
